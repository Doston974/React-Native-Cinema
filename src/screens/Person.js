...
import { fetchPersonDetail, fetchPersonMovies, image342 } from "./../api/index";
    ...
    >
      ...
      {isLoading ? (
        ...
        <View>
          ...
          >
            <View className="items-center rounded-full overflow-hidden h-72 w-72 border-neutral-500 border-2 mt-8">
              <Image
